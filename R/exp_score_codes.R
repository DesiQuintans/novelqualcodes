...
#'
#' @description
#' The definition of whether a code is _novel_ or _duplicated_ is entirely
#' chronological; a **novel code** is a topic/idea/concept that Interviewee 17
#' mentions, but which was not mentioned by Interviewees 1 through 16. A
#' **duplicate code** is one that has been talked about by other interviewees
#' previously. The cumulative sum of novel codes is used to visualise a stopping
#' point for qualitative interviews.
#'
#' @param df_list (List) A list of dataframes, as generated by [import_coding_matrices()].
#'
